...
class MainMenu(Event_Base.EventBase):
    def __init__(self, slot_width, slot_height, win_length):
        ...
        self.no_name = False
        self.button_manager.append('red', 'Red', Vector.Vector(center.x, center.y + 100), Vector.Vector(100, 100), on_click=partial(self.colour, 'red'), idle_texture=Sprites_.red_disc,
        ...
        self.button_manager.append('yellow', 'Yellow', Vector.Vector(center.x, center.y - 100), Vector.Vector(100, 100), on_click=partial(self.colour, 'yellow'), idle_texture=Sprites_.yellow_disc,
                                   ...
                                   click_text_colour=(200, 200, 200))
        self.button_manager.append('green', 'Green', Vector.Vector(center.x + 100, center.y), Vector.Vector(100, 100), on_click=partial(self.colour, 'green'), idle_texture=Sprites_.green_disc,
                                   ...
                                   click_text_colour=(200, 200, 200))
        self.button_manager.append('blue', 'Blue', Vector.Vector(center.x - 100, center.y), Vector.Vector(100, 100), on_click=partial(self.colour, 'blue'), idle_texture=Sprites_.blue_disc,
                                   ...
                                   click_text_colour=(200, 200, 200))
        self.button_manager.append('pink', 'Pink', Vector.Vector(center.x + 100, center.y + 100), Vector.Vector(100, 100), on_click=partial(self.colour, 'pink'), idle_texture=Sprites_.pink_disc,
                                   ...
                                   click_text_colour=(200, 200, 200))
        self.button_manager.append('lime', 'Lime', Vector.Vector(center.x - 100, center.y + 100), Vector.Vector(100, 100), on_click=partial(self.colour, 'lime'), idle_texture=Sprites_.lime_disc,
                                   ...
                                   click_text_colour=(200, 200, 200))
        self.button_manager.append('orange', 'Orange', Vector.Vector(center.x + 100, center.y - 100), Vector.Vector(100, 100), on_click=partial(self.colour, 'orange'),
        ...
        self.button_manager.append('purple', 'Purple', Vector.Vector(center.x - 100, center.y - 100), Vector.Vector(100, 100), on_click=partial(self.colour, 'purple'),
    ...
    def on_draw(self):
        super().on_draw()
        arcade.draw_rectangle_filled(450, 450 + 50, 250, 49, (0, 0, 0))
    ...
    def enter_button(self):
        player_username = self.username.text
        if self.no_name:
            self.no_colour = False
    ...
    def establish_connection(self):
        ...
        string = {
            'type': 'command',
            'command': 'join',
            'args': [f'{self.username.text}', f'{self.current_colour}', (self.slot_width, self.slot_height), self.win_length],
        }
